...
void gobu_project_editor_init(GtkApplication* app)
{
...

    {
        ...
        gtk_header_bar_pack_start(headerbar, switcher);
        ...
        GtkStackPage* world = gtk_stack_add_titled(stack, gobu_editor_world_new(), "world", bugo_project_get_name());
        GtkStackPage* codes = gtk_stack_add_titled(stack, gobu_script_editor_new(), "code", "Component");

        gtk_stack_page_set_icon_name(world, "input-gaming-symbolic");
        gtk_stack_page_set_icon_name(codes, "media-view-subtitles-symbolic");
    }
