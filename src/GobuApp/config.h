...
#define BROWSER_FILE_COMPONENT  ".component"
#define BROWSER_FILE_SCRIPT     ".lua"
#define BROWSER_FILE_SCENE      ".scene"
#define BROWSER_FILE_TILEMAP    ".tilemap"
#define BROWSER_FILE_SPRITE     ".sprite"
#define BROWSER_FILE_PREFAB     ".prefab"
#define BROWSER_FILE_ANIMATION  ".anim"
#define BROWSER_FILE_TILESET    ".tileset"
#define BROWSER_FILE_IMAGE      ".png"
#define BROWSER_FILE_IMAGE2     ".jpg"
