...
static GtkWidget *gapp_project_setting_prop_color_new(const char *tooltip, gchar *id_property)
{
    ...
    g_signal_connect(color_button, "notify::rgba", G_CALLBACK(gapp_project_config_s_color_activate), stringDup(id_property));
...
static GtkWidget *gapp_project_setting_prop_select_new(const char *const *strings, const char *tooltip, gchar *id_property)
{
    ...
    g_signal_connect(select_option, "notify::selected", G_CALLBACK(gapp_project_config_s_select_activate), stringDup(id_property));
...
static GtkWidget *gapp_project_setting_prop_check_new(const gchar *label, const char *tooltip, gchar *id_property)
{
    ...
    g_signal_connect(check, "toggled", G_CALLBACK(gapp_project_config_s_check_toggled), stringDup(id_property));
...
static GtkWidget *gapp_project_setting_prop_number_new(const char *tooltip, gchar *id_property)
{
    ...
    g_signal_connect(number_spin, "value-changed", G_CALLBACK(gapp_project_config_s_spin_button_changed), stringDup(id_property));
...
static void gapp_project_config_s_entry_changed(GtkEditable *self, gchar *id_property)
{
    ...
    g_object_set(gapp_get_config_instance(), id_property, stringDup(text), NULL);
}
...
static GtkWidget *gapp_project_setting_prop_entry_new(const char *placeholder, const char *tooltip, const gchar *id_property)
{
    ...
    g_signal_connect(entry, "changed", G_CALLBACK(gapp_project_config_s_entry_changed), stringDup(id_property));
...
static GtkWidget *gapp_project_setting_prop_text_view_new(const gchar *id_property)
{
    ...
    g_signal_connect(gtk_text_view_get_buffer(text_view), "changed", G_CALLBACK(gapp_project_config_s_text_view_changed), stringDup(id_property));
