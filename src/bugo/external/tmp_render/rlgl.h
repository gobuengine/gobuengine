...
void rlLoadExtensions(void *loader)
{
    ...
    // RLGL.ExtSupported.texCompASTC = epoxy_has_gl_extension("KHR_texture_compression_astc_hdr") && epoxy_has_gl_extension("KHR_texture_compression_astc_ldr");
    // RLGL.ExtSupported.texCompDXT = epoxy_has_gl_extension("EXT_texture_compression_s3tc");  // Texture compression: DXT
    // RLGL.ExtSupported.texCompETC2 = epoxy_has_gl_extension("GL_ARB_ES3_compatibility");        // Texture compression: ETC2/EAC
    #if defined(GRAPHICS_API_OPENGL_43)
