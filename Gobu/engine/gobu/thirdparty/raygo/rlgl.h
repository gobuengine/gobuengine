...
RLAPI void rlLoadExtensions(void);              // Load OpenGL extensions (loader function required)
...
void rlLoadExtensions(void)
{
    ...
    RLGL.ExtSupported.vao = GL_ARB_vertex_array_object;
    RLGL.ExtSupported.instancing = (GL_EXT_draw_instanced && GL_ARB_instanced_arrays);
    RLGL.ExtSupported.texNPOT = GL_ARB_texture_non_power_of_two;
    RLGL.ExtSupported.texFloat32 = GL_ARB_texture_float;
    RLGL.ExtSupported.texFloat16 = GL_ARB_texture_float;
    RLGL.ExtSupported.texDepth = GL_ARB_depth_texture;
    RLGL.ExtSupported.maxDepthBits = 32;
    RLGL.ExtSupported.texAnisoFilter = GL_EXT_texture_filter_anisotropic;
    RLGL.ExtSupported.texMirrorClamp = GL_EXT_texture_mirror_clamp;
#else
    // Register supported extensions flags
    ...
    RLGL.ExtSupported.texCompASTC = GL_KHR_texture_compression_astc_hdr && GL_KHR_texture_compression_astc_ldr;
    RLGL.ExtSupported.texCompDXT = GL_EXT_texture_compression_s3tc;  // Texture compression: DXT
    RLGL.ExtSupported.texCompETC2 = GL_ARB_ES3_compatibility;        // Texture compression: ETC2/EAC
    #if defined(GRAPHICS_API_OPENGL_43)
    RLGL.ExtSupported.computeShader = GL_ARB_compute_shader;
    RLGL.ExtSupported.ssbo = GL_ARB_shader_storage_buffer_object;
    #endif
